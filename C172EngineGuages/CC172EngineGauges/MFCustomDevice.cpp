...
/* **********************************************************************************
    ...
    The custom type is "CC172EngineGauges", which means 14 characters plus NULL = 15
...
void MFCustomDevice::attach(uint16_t adrPin, uint16_t adrType, uint16_t adrConfig, bool configFromFlash)
{
    ...
    ********************************************************************************** */
    ...
    if (strcmp(parameter, "CC172EngineGauges") == 0)
    ...
    if (_customType == MY_CUSTOM_DEVICE_1) {
        ...
        ********************************************************************************** */
        if (!FitInMemory(sizeof(CC172EngineGauges))) {
        ...
        ********************************************************************************** */
        ...
        _mydevice = new (allocateMemory(sizeof(CC172EngineGauges))) CC172EngineGauges(_pin1, _pin2);
